...
| `avatarSize` | `'small' \| 'medium' \| 'large'` | avatar size 22/26/32px (default medium) |
...
| `--gsb-avatar-size` | px | avatar size: small `22px` / medium `26px` / large `32px` (monogram font auto-scales) |
