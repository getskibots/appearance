...
| `avatarSize` | `'small' \| 'medium' \| 'large'` | avatar size 22/26/36px (default medium) |
...
| `--gsb-avatar-size` | px | avatar size: small `22px` / medium `26px` / large `36px` (monogram font auto-scales) |
